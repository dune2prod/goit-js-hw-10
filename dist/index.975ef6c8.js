...
function onInputSelect(event) {
    (0, _catApiJs.fetchCatByBreed)(event).then((data)=>{
...
// createCatCardMarkup()
(0, _catApiJs.fetchBreeds)().then((data)=>createCatlistMarkup(data));

},{"./cat-api.js":"d7YdZ"}],"d7YdZ":[function(require,module,exports) {
...
const fetchCatByBreed = function(event) {
    console.log(event.target.value);
    return fetch(`${BASE_URL}/images/search?breed_ids=${event.target.value}&${API_KEY}`).then((Response)=>{
